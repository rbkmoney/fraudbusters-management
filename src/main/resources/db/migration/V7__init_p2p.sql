...
CREATE UNIQUE INDEX p2p_wb_list_key on af.p2p_wb_list_records (identity_id, list_type, list_name, value);
...
CREATE UNIQUE INDEX p2p_f_reference_key on af.p2p_f_reference (identity_id, is_global);
...
CREATE UNIQUE INDEX p2p_f_group_reference_key on af.p2p_f_group_reference (identity_id);
