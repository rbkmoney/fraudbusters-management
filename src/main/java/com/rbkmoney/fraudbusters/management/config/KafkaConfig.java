...
public class KafkaConfig {
    ...
    private KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Command>> createDefaultContainerFactory(ConsumerFactory<String, Command> consumerReferenceFactory) {
